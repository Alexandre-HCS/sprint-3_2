...
class Locadora
{
    ...
    {
        return match ($tipo) {
            'Terno_c'   => (new Terno_c('', '', null))->calcularAluguel($dias),
            'Smoking'   => (new Smoking('', '', null))->calcularAluguel($dias),
            'Blazer'    => (new Blazer('', '', null))->calcularAluguel($dias),
            'Vestido_l' => (new Vestido_l('', '', null))->calcularAluguel($dias),
            'Vestido_c' => (new Vestido_c('', '', null))->calcularAluguel($dias),
            'Vestido_d' => (new Vestido_d('', '', null))->calcularAluguel($dias),
            default     => 0.0,
        };
    }
}
